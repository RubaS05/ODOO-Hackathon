...
import { 
  LayoutGrid, ClipboardList, Users, TableProperties, Package, 
  Tags, CreditCard, Ticket, UserSquare2, ChefHat, BarChart3, 
  LogOut, Sun, Moon, Bell, Menu, X, Clock 
} from 'lucide-react';
...
export const DashboardLayout: React.FC<{ children?: React.ReactNode }> = ({ children }) => {
  ...
  const menuItems = [
    { name: 'POS Order', path: '/', icon: LayoutGrid },
    ...
    { name: 'Users / Employees', path: '/users', icon: UserSquare2 },
