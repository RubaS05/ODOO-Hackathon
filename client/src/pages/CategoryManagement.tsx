            ...
            <div className="grid grid-cols-6 gap-2 p-3 bg-accent/20 rounded-lg border border-border/20">
              {PREMIUM_COLORS.map((hex) => (
                <button
                  ...
                  className={`w-8 h-8 rounded-full border-2 transition-all cursor-pointer mx-auto ${
                    color === hex ? 'border-primary scale-110 shadow-md' : 'border-transparent hover:scale-105'
                  }`}
