...
import { Ticket, Percent, Plus, Trash2, ShieldAlert } from 'lucide-react';
...
export const CouponsPromotions: React.FC = () => {
  const { 
    coupons, promotions, products,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button 
          onClick={() => activeTab === 'coupons' ? setCouponModalOpen(true) : setPromoModalOpen(true)} 
      ...
      <Modal
        ...
        title="Create Marketing Promotion"
      >
        <form onSubmit={handleCreatePromo} className="space-y-4">
          <Input
            label="Promotion Name"
            placeholder="e.g. Pizza Sunday discount"
            value={promoName}
          ...
          {promoType === 'product' ? (
            ...
            <Input
              label="Minimum Subtotal Required ($)"
              type="number"
              step="0.01"
              value={promoMinAmt}
              onChange={(e) => setPromoMinAmt(e.target.value)}
              required
            />
          )}
