...
export const CustomerDisplay: React.FC = () => {
  ...
  if (successOrder) {
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 text-white text-center relative overflow-hidden">
        {/* Gradients */}
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col justify-between p-8 text-white relative overflow-hidden">
        {/* Gradients */}
