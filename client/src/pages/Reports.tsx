...
import { TrendingUp, DollarSign, ShoppingBag, Percent, FileText, Download } from 'lucide-react';
...
export const Reports: React.FC = () => {
  ...
  const topProducts = useMemo(() => {
    const list: Record<string, { name: string; category: string; qty: number; sales: number }> = {};
