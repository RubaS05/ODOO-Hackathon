...
export const AppRoutes = () => {
    return (<Routes>
      ...
      {/* Protected POS Dashboard Routes (All Authenticated Users) */}
      <Route element={<ProtectedRoute />}>
        <Route path="/" element={<DashboardLayout><POSOrder /></DashboardLayout>}/>
        ...
        <Route path="/kds" element={<DashboardLayout><KDS /></DashboardLayout>}/>
      </Route>
